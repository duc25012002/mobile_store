...
function displayProductDetail(productData) {
  ...
  if (productData) {
    ...
    productDetailContainer.innerHTML = `
      ...
      productData.data.variants[variant_Index].images[0].image_url
            ...
            <div class="col-lg-7">
                ...
                <div class="product-details-contentt">
                    ...
                    <span class="regular-price"><span class="special-price">${formatPrice(
                      productData.data.variants[variant_Index].price *
                          ...
                          <ul>
                              ${productData.data.variants
                                .map(
                                  (variant) => `
                                  <li>
                                      <a style="background-color: ${variant.color_code}" title="${variant.color}" data-id="${variant.id}"></a>
                                  </li>
                              `
                                )
                                .join("")}
    ...
    document.querySelector(".btn-cart").addEventListener("click", () => {
      const product_detail_Id = productData.data.variants[variant_Index].id;

      console.log("ID sản phẩm:", product_detail_Id);
    ...
    document.querySelectorAll(".color-optionn ul li a").forEach((indexLink) => {
      indexLink.addEventListener("click", (event) => {
        event.preventDefault();
        const colorId = parseInt(indexLink.getAttribute("data-id"));
